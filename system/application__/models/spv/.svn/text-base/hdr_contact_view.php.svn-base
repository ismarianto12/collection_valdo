        ...
        <div class="boxmid_box">
            <table class="midleft">
                <form action="#" method="post">
                    <tr class="listB"><td class="tit">Name</td> <td><input type="text" value="" style="width:200px" name="name_debt" id="name"  /><input type="button" onclick="get_input('<?= site_url()
?>user/hdr_contact_cont/go_filter');return false;"  name="submit" value="GO" /><img src="<?= base_url()
?>assets/images/ico_company.png" style="" width="30" /></td></tr>
                <tr class="listA"><td class="tit">SEARCH ACCOUNT </td> <td><input type="text" value="" style="width:200px" name="search_acct" id="search_acct"  /><input type="submit" name="button" onclick="get_input('<?= site_url()
?>user/hdr_contact_cont/go_filter');return false;"  value="GO" /></td></tr>
                <tr class="listB"><td class="tit">1. NO AGREEMENT</td> <td><?= $a_value[0]
?></form>
            <tr class="listA"><td class="tit">2. NAMA</td> <td><h1><?= $a_value[1] ?></h1></td></tr>
...
<?php endif; ?>
            ...
            <tr class="listB"><td class="tit">3. GENDER</td> <td><?= $a_value[39] ?></td></tr>
            <tr class="listA"><td class="tit">4. BUCKET</td> <td><?= $a_value[3] ?></td></tr>
            <tr class="listB"><td class="tit">5. TENOR</td> <td><?= $a_value[4] ?></td></tr>
            <tr class="listA"><td class="tit">6. DUE DATE</td> <td> <?= date_formating($a_value[5]) ?> </td></tr>
            <tr class="listB"><td class="tit">7. Angs ke</td> <td><?= $a_value[6] ?></td></tr>
            <tr class="listA"><td class="tit">8. O/S Balance</td> <td><?= ($a_value[7] != 'no DATA' && trim($a_value[7]) != '' && isset($a_value[7]) ? number_format($a_value[7]) : '')  ?></td></tr>
            <tr class="listB"><td class="tit">9. AMOUNT DUE</td> <td class="currency"><h2><?= @price_format($a_value[8]) ?></h2></td></tr>
            <tr class="listB"><td class="tit">   DENDA</td> <td class="currency"><h2><?= @price_format($a_value[9]) ?></h2></td></tr>
    ...
    <div class="boxmid_box">
        <table class="midleft" cellpadding="3" cellspacing="2">
            <tr class="listB"><td class="tit">10. REGION</td> <td><span class="max_ptp"><?= $a_value[11] ?></span></td></tr>
            <tr class="listA"><td class="tit">11. BRANCH/POS</td> <td><?= $a_value[12] ?> / <?= $a_value[13] ?></td></tr>
            <tr class="listB"><td class="tit">12. RESIDENCE CITY</td> <td><?= $a_value[14] ?></td></tr>
            <tr class="listA"><td class="tit">13. RESIDENCE KECAMATAN</td> <td><?= $a_value[14] ?></td></tr>
            <tr class="listB"><td class="tit">14. RESIDENCE KELURAHAN</td> <td><?= $a_value[16] ?></td></tr>
            <tr class="listA"><td class="tit">15. ALAMAT KTP</td> <td><?= ($a_value[49] . ' ' . $a_value[50] . ' ' . $a_value[51] . ' ' . $a_value[52]) ?></td></tr>
            <tr class="listB"><td class="tit">16. ALAMAT TAGIH</td> <td><?= $a_value[18]; ?></td></tr>
            <tr class="listA"><td class="tit">17. ALAMAT LAIN</td> <td><?= $a_value[18] ?></td></tr>
    ...
    <div class="boxmid_box">
        <table class="midleft">
            ...
            <tr class="listB"><td class="tit">23. PRODUK</td> <td><?= $a_value[29] ?></td></tr>
            <tr class="listA"><td class="tit">24. BRAND</td> <td><?= ($a_value[55] != 'no DATA' && trim($a_value[55]) != '' ? $a_value[55] : '')  ?></td></tr>
            <tr class="listB"><td class="tit">25. MODEL</td> <td><?= $a_value[28] ?></td></tr>
            <tr class="listA"><td class="tit">26. NO RANGKA, NO MESIN / NO Serial</td> <td><?= $a_value[35] ?></td></tr>
            <tr class="listB"><td class="tit">26. NO POL</td> <td><?= $a_value[36] ?></td></tr>
            <tr class="listA"><td class="tit">27. WARNA</td> <td><?= $a_value[37] ?></td></tr>
        </table>
    </div>
    <span class="boxmid_bot"></span>
...
<?php } ?>
            ...
            <table class="midleft" id="addInfo">
                ...
                <?php foreach ($get_other_info->result() as $new_info) {
                        $i++; ?>
                        <tr class="listA" id="info_<?= $new_info->primary_1 ?>"><td class="tit" style="font-weight:bold;"><div class="editInfo"id="<?= $a_value[0] ?>"><?= strtoupper($new_info->info) ?></div><a class="title" id="no_under" title="Created by : <?= $new_info->username ?>|Created Date : <?= $new_info->createdate ?>" href="#">&nbsp;&nbsp;- Edit By -&nbsp;&nbsp; </td></a></tr>
                <?php
            }
        } else {
...
<div class="cmidleft">
    ...
    <div class="boxmid_box">
        <table class="midleft">
            <tr class="listA"><td class="tit">28. EMERGENCY CONTACT</td> <td><?= ($a_value[49] != 'NULL' ? $a_value[49] : '') ?></td></tr>
            <tr class="listB"><td class="tit">29. HUBUNGAN DENGAN EMERGENCY</td> <td><?= $a_value[50]
                ?></td></tr>
            <tr class="listA"><td class="tit">24. TELP RUMAH</td> <td><?= ($a_value[20] != 'NULL' ? $a_value[20] : '') ?></td><td class="call"><input type="button" value="Call" onclick="get_phone('<?= clean_phone($a_value[20])
                ?>')" /></td></tr>
            <tr class="listB"><td class="tit">25. TELP KANTOR</td> <td><?= ($a_value[19] != 'NULL' ? $a_value[19] : '') ?></td><td class="call"><input type="button" value="Call" onclick="get_phone('<?= clean_phone($a_value[19])
                ?>')" /></td></tr>
            <tr class="listA"><td class="tit">26. HP</td> <td><?= ($a_value[21] != 'NULL' ? $a_value[21] : '') ?></td><td class="call"><input type="button" value="Call" onclick="get_phone('<?= clean_phone($a_value[21])
                ?>')" /></td></tr>
            <tr class="listB"><td class="tit">27. EMERGENCY PHONE</td> <td><?= ($a_value[22] != 'NULL' ? $a_value[22] : '') ?></td><td class="call"><input type="button" value="Call" onclick="get_phone('<?= clean_phone($a_value[22])
                ?>')" /></td></tr>
            ...
            <tr class="listB"><td class="tit">32. <strong>108</strong></td> <td><h3>108</h3></td><td class="call"><input type="button" value="Call" onclick="get_phone('108')" /></td></tr>
        </table>
    </div>
    <span class="boxmid_bot"></span>
...
?>
    ...
    <div class="boxmid_box">
        <table class="midleft">
            <tr class="listB"><td class="tit">36. TEMPAT/TGL LAHIR</td> <td><?= $a_value[38]
?></td></tr>
            <tr class="listB"><td class="tit">37. STATUS PERKAWINAN</td> <td><?= $a_value[40]
?></td></tr>
            <tr class="listB"><td class="tit">38. UMUR</td> <td><?= $a_value[41]
?></td></tr>
            <tr class="listA"><td class="tit">39. NAMA IBU KANDUNG</td> <td class="currency"><?= $a_value[42]
?></td></tr>
            <tr class="listB"><td class="tit">40. STATUS RUMAH</td><td class="currency"><?= $a_value[43]
?></td></tr>
            <tr class="listB"><td class="tit">41. PEKERJAAN</td> <td class="currency"><?= $a_value[44]
?></td>
            </tr>
        </table>
