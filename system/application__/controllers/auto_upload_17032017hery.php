...
//die("dorrr");
		...
		public function read_payment2()
    {
		...
		function link_report1(){
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, cell_phone1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '1' AND cell_phone1 != ''
					AND cell_phone1 NOT LIKE '%-%' AND cell_phone1 != '0'
					AND LEFT(cell_phone1, 2) IN ('08','02','03') AND cell_phone1 NOT LIKE '%*%'
					AND cell_phone1 NOT LIKE '%.%' AND cell_phone1 NOT LIKE '%0000%' AND LENGTH(cell_phone1) > 5";
			$this->db->query($sql);
			
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '1' AND phone_1 != ''
					AND phone_1 NOT LIKE '%-%' AND phone_1 != '0'
					AND LEFT(phone_1, 2) IN ('08','02','03') AND phone_1 NOT LIKE '%*%'
					AND phone_1 NOT LIKE '%.%' AND phone_1 NOT LIKE '%0000%'  AND LENGTH(phone_1) > 5
					AND primary_1 NOT IN (
						SELECT primary_1 FROM hdr_debtor_main
						WHERE skip = '1' AND dpd = '1' AND cell_phone1 != ''
						AND cell_phone1 NOT LIKE '%-%' AND cell_phone1 != '0'
						AND LEFT(cell_phone1, 2) IN ('08','02','03') AND cell_phone1 NOT LIKE '%*%'
						AND cell_phone1 NOT LIKE '%.%' AND cell_phone1 NOT LIKE '%0000%'  AND LENGTH(cell_phone1) > 5
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_2 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '1' AND phone_2 != ''
					AND phone_2 NOT LIKE '%-%' AND phone_2 != '0'
					AND LEFT(phone_2, 2) IN ('08','02','03') AND phone_2 NOT LIKE '%*%'
					AND phone_2 NOT LIKE '%.%' AND phone_2 NOT LIKE '%0000%'  AND LENGTH(phone_2) > 5
					AND primary_1 NOT IN (
						SELECT primary_1 FROM hdr_debtor_main
						WHERE skip = '1' AND dpd = '1' AND cell_phone1 != ''
						AND cell_phone1 NOT LIKE '%-%' AND cell_phone1 != '0'
			...
			$this->db->query($sql);
			$sql = "select idx, no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang from report";
			//die('haha');
			$file_now = "DPD1.txt";
		...
		function link_report2(){
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, cell_phone1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '-3' AND cell_phone1 != ''
					AND cell_phone1 NOT LIKE '%-%' AND cell_phone1 != '0'
					AND LEFT(cell_phone1, 2) IN ('08','02','03') AND cell_phone1 NOT LIKE '%*%'
					AND cell_phone1 NOT LIKE '%.%' AND cell_phone1 NOT LIKE '%0000%' AND LENGTH(cell_phone1) > 5";
			$this->db->query($sql);
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '-3' AND phone_1 != ''
					AND phone_1 NOT LIKE '%-%' AND phone_1 != '0'
					AND LEFT(phone_1, 2) IN ('08','02','03') AND phone_1 NOT LIKE '%*%'
					AND phone_1 NOT LIKE '%.%' AND phone_1 NOT LIKE '%0000%'  AND LENGTH(phone_1) > 5
					AND primary_1 NOT IN (
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_2 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '-3' AND phone_2 != ''
					AND phone_2 NOT LIKE '%-%' AND phone_2 != '0'
					AND LEFT(phone_2, 2) IN ('08','02','03') AND phone_2 NOT LIKE '%*%'
					AND phone_2 NOT LIKE '%.%' AND phone_2 NOT LIKE '%0000%'  AND LENGTH(phone_2) > 5
					AND primary_1 NOT IN (
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, cell_phone1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '-2' AND cell_phone1 != ''
					AND cell_phone1 NOT LIKE '%-%' AND cell_phone1 != '0'
					AND LEFT(cell_phone1, 2) IN ('08','02','03') AND cell_phone1 NOT LIKE '%*%'
					AND cell_phone1 NOT LIKE '%.%' AND cell_phone1 NOT LIKE '%0000%' AND LENGTH(cell_phone1) > 5";
			$this->db->query($sql);
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '-2' AND phone_1 != ''
					AND phone_1 NOT LIKE '%-%' AND phone_1 != '0'
					AND LEFT(phone_1, 2) IN ('08','02','03') AND phone_1 NOT LIKE '%*%'
					AND phone_1 NOT LIKE '%.%' AND phone_1 NOT LIKE '%0000%'  AND LENGTH(phone_1) > 5
					AND primary_1 NOT IN (
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_2 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '-2' AND phone_2 != ''
					AND phone_2 NOT LIKE '%-%' AND phone_2 != '0'
					AND LEFT(phone_2, 2) IN ('08','02','03') AND phone_2 NOT LIKE '%*%'
					AND phone_2 NOT LIKE '%.%' AND phone_2 NOT LIKE '%0000%'  AND LENGTH(phone_2) > 5
					AND primary_1 NOT IN (
		...
		function link_report4(){
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, cell_phone1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '0' AND cell_phone1 != ''
					AND cell_phone1 NOT LIKE '%-%' AND cell_phone1 != '0'
					AND LEFT(cell_phone1, 2) IN ('08','02','03') AND cell_phone1 NOT LIKE '%*%'
					AND cell_phone1 NOT LIKE '%.%' AND cell_phone1 NOT LIKE '%0000%' AND LENGTH(cell_phone1) > 5";
			$this->db->query($sql);
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_1 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '0' AND phone_1 != ''
					AND phone_1 NOT LIKE '%-%' AND phone_1 != '0'
					AND LEFT(phone_1, 2) IN ('08','02','03') AND phone_1 NOT LIKE '%*%'
					AND phone_1 NOT LIKE '%.%' AND phone_1 NOT LIKE '%0000%'  AND LENGTH(phone_1) > 5
					AND primary_1 NOT IN (
			...
			$sql = "INSERT INTO report(no_kontrak, nama, phone, angsuran, jenis, merk, nopol, jatuh_tempo, minimum, tagihan, kode_cabang)
					SELECT primary_1 AS no_kontrak, LOWER( NAME ) AS nama, phone_2 AS New_phone, angsuran_ke AS angsuran, SUBSTRING_INDEX( LOWER( product ) , '/', 1 ) AS jenis, SUBSTRING_INDEX( LOWER( product ) , '/', -1 ) AS merk, police_no AS nopol, due_date AS jatuh_tempo,shift AS minimum, debt_amount AS tagihan, kode_cabang 
					FROM hdr_debtor_main
					WHERE skip = '1' AND dpd = '0' AND phone_2 != ''
					AND phone_2 NOT LIKE '%-%' AND phone_2 != '0'
					AND LEFT(phone_2, 2) IN ('08','02','03') AND phone_2 NOT LIKE '%*%'
					AND phone_2 NOT LIKE '%.%' AND phone_2 NOT LIKE '%0000%'  AND LENGTH(phone_2) > 5
					AND primary_1 NOT IN (
