...
//die('eheheheh');
 ...
 public function get_handling($begindate,$enddate,$spv){
	...
	IFNULL(c.description,CASE a.id_handling_code WHEN '03' THEN 'SALAH SAMBUNG' WHEN '04' THEN 'LINE BUSY' WHEN '05' 
	THEN 'NO TELP TIDAK VALID/RUSAK' WHEN '06' THEN 'TIDAK DIANGKAT/NO ANSWER' ELSE '' END) AS 'RESULT HANDLING', a.no_contacted AS 'NOTELP',case 
	...
	ELSE '' END AS STATUS_DEBITUR, hu.fullname AS FULLNAME, a.dpd, a.angsuran_ke FROM hdr_calltrack a
