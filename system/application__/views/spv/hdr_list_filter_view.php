...
<input type="button" id="view_dbo" value="Button Uncontact Hilman" style="background-color: #FFFF00"onclick="boxPopup('Memo BDO','<?php echo site_url() ?>spv/hdr_setup_filter_cont/change_form_hilman/ ');return false;" />
