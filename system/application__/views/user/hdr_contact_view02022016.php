   	...
   	if(!val || val == "" || val.length <= 5){
   	...
   	else
   		{
   		  ...
   		  function callerHandler(){
				...
				//var callerInitLink = 'http://172.25.150.201/cc-writeoff/dial_number.php?dari=SIP/'+channel_user+'&to='+phone_num+'&recid='+cust_id+'&custname='+custname+'&line_number='+channel_user;
    ...
    <div class="cmidleft">
        ...
        <div class="boxmid_box">
            ...
            <?php
						...
						$a_value[9] = str_replace(",00","",$a_value[9]);
						$a_value[7] = str_replace(",00","",$a_value[7]);


            if ($get_ptp_status->num_rows() > 0): ?>
            <?php
...
<?php endif; ?>
            ...
            <tr class="listA"><td class="tit">8. <?php if(@$fin_type == 2) { echo "POKOK UTANG"; } else { echo "OS/AR" ;}?></td> <td><?= ($a_value[9] != 'no DATA' && trim($a_value[9]) != '' && isset($a_value[9]) ? number_format($a_value[9]) : '')  ?></td></tr>
						...
						<?php
							...
							if($a_value[26] == '01' ){
								$product_flag = "Otomotif";
							}else{
								$product_flag = "Durable";
							}

						?>
						<tr class="listB"><td class="tit">9. Product Flag</td> <td><?php echo $product_flag;?></td></tr>
						<?php
							if($a_value[27] == '01' ){
								$in_bucket = "FE";
							}else{
						...
						?>
						<tr class="listB"><td class="tit">10. Bucket Coll</td> <td><?= $in_bucket ?></td></tr>

            <tr class="listA"><td class="tit">11. O/S AR</td> <td><?= ($a_value[9] != 'no DATA' && trim($a_value[9]) != '' && isset($a_value[9]) ? number_format($a_value[9]) : '')  ?></td></tr>
            <tr class="listB"><td class="tit">12. AMOUNT DUE</td> <td class="currency"><h2><?= @price_format($a_value[7]) ?></h2></td></tr>
            <tr class="listA"><td class="tit">13. <?php if(@$fin_type == 2) { echo "SANKSI KETERLAMBATAN"; } else { echo "DENDA" ;} ?></td> <td class="currency"><h2><span id="due_val" class="due_val"></span></h2></td></tr>
        ...
        <table class="midleft">
          <!--
            ...
            <tr class="listB"><td class="tit">HUBUNGAN DENGAN EMERGENCY</td> <td><?= $a_value[50]
                ?></td></tr>
            <tr class="listA"><td class="tit">TELP RUMAH</td> <td><?= ($a_value[20] != 'NULL' ? $a_value[20] : '') ?></td><td class="call"><input type="button" value="Call" onclick="get_phone('<?= clean_phone($a_value[20])
                ?>')" /></td></tr>
            <tr class="listB"><td class="tit">TELP KANTOR</td> <td><?= ($a_value[19] != 'NULL' ? $a_value[19] : '') ?></td><td class="call"><input type="button" value="Call" onclick="get_phone('<?= clean_phone($a_value[19])
                ?>')" /></td></tr>
           ...
           <!-- End Clean-->
            ...
            <tr class="listA"><td class="tit">27. HP</td> <td><?php if($is_cleaned14 == 1) {echo "<span style='color:grey'>021</span>";} ?><?= ($a_value[14] != '' ? $a_value[14] : '<span style="color:grey">-NoData-</span>') ?></td><td class="call"><input type="button" id="mobile_phone" value="Call" onclick="call('<?php echo(trim($a_value[14]));?>','03')" /></td></tr>
            ...
            <tr class="listA"><td class="tit">31.Emergency Contact Name</td><td colspan="2"><?= (count($a_value) > 28 ? $a_value[28] : '');?></td></tr>
						<tr class="listB"><td class="tit">32.Emergency Phone No</td><td colspan="2"><?= (count($a_value) > 29 ? $a_value[29] : '');?></td></tr>
            <tr class="listA"><td class="tit">33.Nama Penjamin</td> <td colspan="2"><?= (count($a_value) > 30 ? $a_value[30] : '');?></td><tr>
						<tr class="listB"><td class="tit">34.No Telp Penjamin</td><td colspan="2"><?= (count($a_value) > 31 ? $a_value[31] : '');?></td><tr>
            <tr class="listA"><td class="tit">35.Alamat Nasabah</td> <td colspan="2"><?= (count($a_value) > 32 ? $a_value[32] : '');?></td><tr>
						<tr class="listB"><td class="tit">36.Alamat Kantor</td><td colspan="2"><?= (count($a_value) > 33 ? $a_value[33] : '');?></td><tr>
