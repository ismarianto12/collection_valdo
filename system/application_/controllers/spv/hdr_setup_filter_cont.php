...
//var_dump(@$_SESSION['username']);
	...
	$sql = "update hdr_debtor_main s, hdr_calltrack a set s.in_use=0,s.called=0 where a.primary_1=s.primary_1 and s.in_use=1 and s.skip=0 and s.id_user>0 and s.valdo_cc='01' and (s.is_paid IS NULL or s.is_paid = 0)and last_ptp_date='0000-00-00' and a.id_handling_code='04' and a.id_spv='584'and a.call_date=curdate() ";
