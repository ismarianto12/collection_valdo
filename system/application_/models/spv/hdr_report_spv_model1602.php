  ...
  class Hdr_report_spv_model extends Model {
      ...
      public function status_call($user, $id_user, $status, $begindate, $enddate) {
          ...
          $sql = " SELECT
                      ...
                      ROUND((COUNT(DISTINCT hc.id_calltrack)/($total_days*$xtarget)*5),'2') AS 'arch_work',
                      ROUND((0.7*($total_days*$xtarget))) AS 'target_contact',
                      COUNT(DISTINCT CASE WHEN (hc.id_call_cat='1') 
                      	THEN  hc.id_calltrack  END ) AS 'contact',
                      ROUND(((COUNT(DISTINCT CASE WHEN (hc.id_call_cat='1') THEN hc.id_calltrack END ))/(0.7*($total_days*$xtarget))*10),'2') AS 'arch_contact',
                      COUNT(DISTINCT CASE WHEN (hc.id_call_cat='2') 
                      	THEN hc.id_calltrack  END ) AS 'no_contact',
                      ROUND((0.8*((0.7*($total_days*$xtarget))))) AS 'target_ptp',
                      ...
                      ROUND(((COUNT(DISTINCT CASE WHEN hc.id_handling_code = '02' AND ptp_date IS NOT NULL AND ptp_date != '0000-00-00' THEN hc.id_calltrack END ))/(ROUND((0.8*((0.7*($total_days*$xtarget))))))*15),'2') AS 'arch_ptp',
                      ROUND((0.8*(ROUND((0.8*((0.7*($total_days*$xtarget)))))))) AS 'target_keep',
                      COUNT(DISTINCT CASE WHEN hc.ptp_status = '2' AND hc.id_handling_code = '02' THEN hc.primary_1 END ) AS 'keep',                      
                      ROUND((COUNT(DISTINCT CASE WHEN hc.ptp_status = '2' AND hc.id_handling_code = '02' THEN hc.primary_1 END ))/(ROUND((0.8 * ROUND((0.8*((0.7*($total_days*$xtarget))))))))*70,'2') AS 'arch_keep',
...
*/     
      ...
      ## Martin[30 Dec 2011]-> count available 
		...
		*/
		...
		$sql = "SELECT valdo_cc, COUNT( CASE WHEN is_new = 1 THEN primary_1 END ) AS total_data_1
					FROM hdr_debtor_main
					where valdo_cc = '$location'";
		$query = $this->db->query($sql);
		$wo_total = $query->row_array();
        return $wo_total;
		...
		/*$sql = "select
					...
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '31' THEN hdm.primary_1 END)) AS total_data_31
					from hdr_debtor_main_inventory hdm 
					WHERE (hdm.skip = 1 OR hdm.is_paid = 1 OR hdm.paid = 1) and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'  and hdm.valdo_cc = '$location' ";*/
		$sql = "SELECT valdo_cc, COUNT( CASE WHEN (skip = 1 OR is_paid = 1 OR paid = 1) THEN primary_1 END ) AS total_data_1
					FROM hdr_debtor_main
					where valdo_cc = '$location'";
		...
		public function daily_report6($month,$year,$location) {
		
		$sql = "select
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '1' THEN hc.primary_1 END)) AS total_data_1,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '2' THEN hc.primary_1 END)) AS total_data_2,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '3' THEN hc.primary_1 END)) AS total_data_3,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '4' THEN hc.primary_1 END)) AS total_data_4,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '5' THEN hc.primary_1 END)) AS total_data_5,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '6' THEN hc.primary_1 END)) AS total_data_6,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '7' THEN hc.primary_1 END)) AS total_data_7,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '8' THEN hc.primary_1 END)) AS total_data_8,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '9' THEN hc.primary_1 END)) AS total_data_9,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '10' THEN hc.primary_1 END)) AS total_data_10,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '11' THEN hc.primary_1 END)) AS total_data_11,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '12' THEN hc.primary_1 END)) AS total_data_12,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '13' THEN hc.primary_1 END)) AS total_data_13,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '14' THEN hc.primary_1 END)) AS total_data_14,
					COUNT(distinct (case day(hc.call_date) when '15' then hc.primary_1 end)) as total_data_15,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '16' THEN hc.primary_1 END)) AS total_data_16,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '17' THEN hc.primary_1 END)) AS total_data_17,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '18' THEN hc.primary_1 END)) AS total_data_18,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '19' THEN hc.primary_1 END)) AS total_data_19,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '20' THEN hc.primary_1 END)) AS total_data_20,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '21' THEN hc.primary_1 END)) AS total_data_21,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '22' THEN hc.primary_1 END)) AS total_data_22,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '23' THEN hc.primary_1 END)) AS total_data_23,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '24' THEN hc.primary_1 END)) AS total_data_24,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '25' THEN hc.primary_1 END)) AS total_data_25,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '26' THEN hc.primary_1 END)) AS total_data_26,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '27' THEN hc.primary_1 END)) AS total_data_27,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '28' THEN hc.primary_1 END)) AS total_data_28,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '29' THEN hc.primary_1 END)) AS total_data_29,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '30' THEN hc.primary_1 END)) AS total_data_30,
					COUNT(DISTINCT (CASE DAY(hc.call_date) WHEN '31' THEN hc.primary_1 END)) AS total_data_31
					from hdr_calltrack hc
					...
					and hdm.valdo_cc = '$location'
					where MONTH(hc.call_date) = '$month' AND YEAR(hc.call_date) = '$year'";
		...
		public function daily_report7($month,$year,$location) {
		...
		$sql = "select
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and MONTH(hdm.data_date) = '$month' AND YEAR(hdm.data_date) = '$year'
					and hdm.valdo_cc = '$location'
					where MONTH(hc.call_date) = '$month' AND YEAR(hc.call_date) = '$year' AND hc.id_call_cat='1'";
		...
		public function daily_report8($month,$year,$location) {
		...
		$sql = "select
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and MONTH(hdm.data_date) = '$month' AND YEAR(hdm.data_date) = '$year'
					and hdm.valdo_cc = '$location'
					where MONTH(hc.call_date) = '$month' AND YEAR(hc.call_date) = '$year' and hc.id_handling_code = '02' AND hc.ptp_date IS NOT NULL AND hc.ptp_date != '0000-00-00'
					";
		...
		public function daily_report9($month,$year,$location) {
		...
		$sql = "select
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and MONTH(hdm.data_date) = '$month' AND YEAR(hdm.data_date) = '$year'
					and hdm.valdo_cc = '$location'
					where MONTH(hc.call_date) = '$month' AND YEAR(hc.call_date) = '$year' and hc.ptp_status = '2' AND hc.id_handling_code = '02'";
		...
		public function daily_report10($month,$year,$location) {
		...
		$sql = "select
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and MONTH(hdm.data_date) = '$month' AND YEAR(hdm.data_date) = '$year'
					and hdm.valdo_cc = '$location'
					where MONTH(hc.call_date) = '$month' AND YEAR(hc.call_date) = '$year' AND hc.id_call_cat='2'";
		...
		public function daily_report11($month,$year,$location) {
		...
		/*$sql = "select hc.call_date,
					...
					from hdr_calltrack hc
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					WHERE hdm.is_new = '1' and hdm.last_handling_date = '0000-00-00' and hdm.valdo_cc = '$location' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year' ";*/
					
		$sql = "select hc.call_date,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '1' THEN hc.primary_1 END)) AS total_data_1,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '2' THEN hc.primary_1 END)) AS total_data_2,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '3' THEN hc.primary_1 END)) AS total_data_3,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '4' THEN hc.primary_1 END)) AS total_data_4,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '5' THEN hc.primary_1 END)) AS total_data_5,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '6' THEN hc.primary_1 END)) AS total_data_6,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '7' THEN hc.primary_1 END)) AS total_data_7,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '8' THEN hc.primary_1 END)) AS total_data_8,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '9' THEN hc.primary_1 END)) AS total_data_9,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '10' THEN hc.primary_1 END)) AS total_data_10,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '11' THEN hc.primary_1 END)) AS total_data_11,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '12' THEN hc.primary_1 END)) AS total_data_12,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '13' THEN hc.primary_1 END)) AS total_data_13,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '14' THEN hc.primary_1 END)) AS total_data_14,
					COUNT(distinct (case day(hdm.data_date) when '15' then hc.primary_1 end)) as total_data_15,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '16' THEN hc.primary_1 END)) AS total_data_16,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '17' THEN hc.primary_1 END)) AS total_data_17,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '18' THEN hc.primary_1 END)) AS total_data_18,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '19' THEN hc.primary_1 END)) AS total_data_19,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '20' THEN hc.primary_1 END)) AS total_data_20,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '21' THEN hc.primary_1 END)) AS total_data_21,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '22' THEN hc.primary_1 END)) AS total_data_22,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '23' THEN hc.primary_1 END)) AS total_data_23,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '24' THEN hc.primary_1 END)) AS total_data_24,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '25' THEN hc.primary_1 END)) AS total_data_25,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '26' THEN hc.primary_1 END)) AS total_data_26,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '27' THEN hc.primary_1 END)) AS total_data_27,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '28' THEN hc.primary_1 END)) AS total_data_28,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '29' THEN hc.primary_1 END)) AS total_data_29,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '30' THEN hc.primary_1 END)) AS total_data_30,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '31' THEN hc.primary_1 END)) AS total_data_31
					from hdr_calltrack hc
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					inner join hdr_debtor_main hdd on hdd.primary_1 = hc.primary_1 and hdd.is_new = '1'
					WHERE hdm.valdo_cc = '$location' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year'";
		...
		public function daily_report12($month,$year,$location) {
		...
		/*$sql = "select hc.call_date,
					...
					from hdr_calltrack hc
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					WHERE hdm.is_new = '1' and hdm.last_handling_date = '0000-00-00' and hdm.valdo_cc = '$location' AND hc.id_call_cat='1' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year' ";*/
		$sql = "select hc.call_date,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '1' THEN hc.primary_1 END)) AS total_data_1,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '2' THEN hc.primary_1 END)) AS total_data_2,
					COUNT(DISTINCT (CASE DAY(hdm.data_date) WHEN '3' THEN hc.primary_1 END)) AS total_data_3,
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					inner join hdr_debtor_main hdd on hdd.primary_1 = hc.primary_1 and hdd.is_new = '1'
					WHERE hdm.valdo_cc = '$location' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year' AND hc.id_call_cat='1'";
		...
		public function daily_report13($month,$year,$location) {
		...
		/*$sql = "select hc.call_date,
					...
					from hdr_calltrack hc
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					WHERE hdm.is_new = '1' and hdm.last_handling_date = '0000-00-00' and hdm.valdo_cc = '$location' and hc.id_handling_code = '02' AND hc.ptp_date IS NOT NULL AND hc.ptp_date != '0000-00-00' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year'";*/
		...
		$sql = "select hc.call_date,
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					inner join hdr_debtor_main hdd on hdd.primary_1 = hc.primary_1 and hdd.is_new = '1'
					WHERE hdm.valdo_cc = '$location' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year' and hc.id_handling_code = '02' AND hc.ptp_date IS NOT NULL AND hc.ptp_date != '0000-00-00'";
		$query = $this->db->query($sql);
		$wo_total = $query->row_array();
        return $wo_total;
		
		}
		public function daily_report14($month,$year,$location) {
		...
		/*$sql = "select hc.call_date,
					...
					from hdr_calltrack hc
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					WHERE hdm.is_new = '1' and hdm.last_handling_date = '0000-00-00' and hdm.valdo_cc = '$location' and hc.ptp_status = '2' AND hc.id_handling_code = '02' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year'";*/
		...
		$sql = "select hc.call_date,
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					inner join hdr_debtor_main hdd on hdd.primary_1 = hc.primary_1 and hdd.is_new = '1'
					WHERE hdm.valdo_cc = '$location' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year' and hc.ptp_status = '2' AND hc.id_handling_code = '02'";
		$query = $this->db->query($sql);
		$wo_total = $query->row_array();
        return $wo_total;
		
		}
		public function daily_report15($month,$year,$location) {
		...
		/*$sql = "select hc.call_date,
					...
					from hdr_calltrack hc
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					WHERE hdm.is_new = '1' and hdm.last_handling_date = '0000-00-00' and hdm.valdo_cc = '$location' AND hc.id_call_cat='2' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year'";*/
		...
		$sql = "select hc.call_date,
					...
					inner join hdr_debtor_main_inventory hdm on hdm.primary_1 = hc.primary_1 and month(hdm.data_date) = '$month' and year(hdm.data_date) = '$year'
					inner join hdr_debtor_main hdd on hdd.primary_1 = hc.primary_1 and hdd.is_new = '1'
					WHERE hdm.valdo_cc = '$location' and month(hc.call_date) = '$month' and year(hc.call_date) = '$year' AND hc.id_call_cat='2'";
		$query = $this->db->query($sql);
		$wo_total = $query->row_array();
        return $wo_total;
		
		}
		public function daily_report16($month,$year,$location) {
		...
		$sql = "select
					...
					from hdr_user hu
					inner join hdr_calltrack hc on hc.id_user = hu.id_user
					where MONTH(hc.call_date) = '$month' AND YEAR(hc.call_date) = '$year'";
