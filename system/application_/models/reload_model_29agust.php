      ...
      public function od_monitor_debtor_main()
      {
		...
		$this->db->query($sql);
      	...
      	$sql = "select count(primary_1) as total_wk_plus2,
			...
			from hdr_debtor_main where valdo_cc='01' and dpd=2 and last_handling_date='0000-00-00'";
      	$q1 = $this->db->query($sql);
      	$row1 = $q1->row_array();
      	$total_wk_plus2 = $row1['total_wk_plus2'];
      	$total_wk_plus2_amount = $row1['total_wk_plus2_amount'];
      	
      	$data['total_plus2'] = $total_wk_plus2;
      	$data['total_plus2_skip'] = 0;
      	$data['total_plus2_amount'] = $total_wk_plus2_amount;
      	...
      	$sql = "select count(primary_1) as total_wk_plus3,
			...
			from hdr_debtor_main where valdo_cc='01' and dpd=3 and last_handling_date='0000-00-00'";
      	$q1 = $this->db->query($sql);
      	$row1 = $q1->row_array();
      	$total_wk_plus3 = $row1['total_wk_plus3'];
      	$total_wk_plus3_amount = $row1['total_wk_plus3_amount'];
      	 
      	$data['total_plus3'] = $total_wk_plus3;
      	$data['total_plus3_skip'] = 0;
      	$data['total_plus3_amount'] = $total_wk_plus3_amount;
      	...
      	$sql = "update hdr_debtor_main hdm,hdr_calltrack hc
			set hdm.last_handling_date=hc.call_date
			where hdm.dpd=5 and hdm.valdo_cc='01' and hc.call_date=date(INTERVAL -1 DAY + now())
			and hdm.primary_1=hc.primary_1
			and hdm.last_handling_date='0000-00-00'";
      	$this->db->query($sql);
      	...
      	$sql = "update hdr_debtor_main hdm,hdr_calltrack hc
			set hdm.last_handling_date=hc.call_date
			where hdm.dpd=6 and hdm.valdo_cc='01' and hc.call_date=date(INTERVAL -2 DAY + now())
			and hdm.primary_1=hc.primary_1
			and hdm.last_handling_date='0000-00-00'";
      	$this->db->query($sql);
      	...
      	$sql = "update hdr_debtor_main hdm,hdr_calltrack hc
			set hdm.last_handling_date=hc.call_date
			where hdm.dpd=9 and hdm.valdo_cc='01' and hc.call_date=date(INTERVAL -1 DAY + now())
			and hdm.primary_1=hc.primary_1
			and hdm.last_handling_date='0000-00-00'";
      	$this->db->query($sql);
      	...
      	$sql = "select count(primary_1) as total_wk_plus9,
			...
			from hdr_debtor_main where valdo_cc='01' and dpd=9 and last_handling_date='0000-00-00'";
      	$q1 = $this->db->query($sql);
      	$row1 = $q1->row_array();
      	...
      	$sql = "update hdr_debtor_main hdm,hdr_calltrack hc
			set hdm.last_handling_date=hc.call_date
			where hdm.dpd=10 and hdm.valdo_cc='01' and hc.call_date=date(INTERVAL -2 DAY + now())
			and hdm.primary_1=hc.primary_1
			and hdm.last_handling_date='0000-00-00'";
      	$this->db->query($sql);
      	...
      	$sql = "update hdr_debtor_main hdm,hdr_calltrack hc
			set hdm.last_handling_date=hc.call_date
			where hdm.dpd=12 and hdm.valdo_cc='01' and hc.call_date=date(INTERVAL -1 DAY + now())
			and hdm.primary_1=hc.primary_1
			and hdm.last_handling_date='0000-00-00'";
      	$this->db->query($sql);
      	...
      	$sql = "update hdr_debtor_main hdm,hdr_calltrack hc
			set hdm.last_handling_date=hc.call_date
			where hdm.dpd=13 and hdm.valdo_cc='01' and hc.call_date=date(INTERVAL -2 DAY + now())
			and hdm.primary_1=hc.primary_1
			and hdm.last_handling_date='0000-00-00'";
      	$this->db->query($sql);
