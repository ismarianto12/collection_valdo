...
//die("d" . $over_days);
    ...
    public function get_call_track_info($primary_1) {
        $sql = "SELECT DISTINCT a.ptp_status, a.call_date, a.username FROM hdr_calltrack a, hdr_debtor_main s
            WHERE a.primary_1=s.primary_1 and a.primary_1='" . $primary_1 . "' AND a.id_handling_code='02'and
		 s.dpd NOT in(8,16,7,4,5,6,7) and s.`score_result`!='HIGH'
