...
<script>
    ...
    function get_full_reportv2(){
    	var location = "<?php echo site_url(); ?>spv/hdr_spv_report_ctrl/get_full_reportv2";
    	//alert(location);
    	//return;
    	this.location.href = location;
    }
