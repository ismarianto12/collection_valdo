				...
				<dl>
					...
					<dt><label class="lblfl">Priority</label>
							<select id="priority" name="priority" class="priority" size="5" style="height:50px;">
								...
								<option value="PTP_Expired">PTP Expired</option>
					...
					<dt><label class="lblfl">Over Days</label>
						    ...
						    <label class="lblfl">Angs Ke</label>
						    
							<select id="angs_ke" name="angs_ke" size="5">
								<option value="" SELECTED>All</option>
								<option value="6"><=6</option>
...
<!--
					...
					<dt>
					<label class="lblfl">Bucket OD Untuk DC2</label>
						<select id="bucket_od" name="bucket_od">
								<option value="">All</option>
								<option value="1">Ke DC1 dengan minus</option>
								<option value="2">Ke DC2</option>
								<option value="3">Ke DC1 0Up</option>
						</select>
						
					<label class="lblfl">Score Result</label>
						<select id="score_result" name="score_result">
								<option value="0">All</option>
								<option value="1">HIGH</option>
								<option value="2">OD 1 - 6</option>
					</select>
