...
class Hdr_contact_cont extends Controller {
    ...
    public function contact() {
        ...
        $getstr = $this->call_track_model->debtor_details($primary_1);
				...
				$sql = "SELECT a.ptp_status,s.dpd FROM hdr_calltrack a, hdr_debtor_main s WHERE a.primary_1 =s.primary_1 and a.primary_1 = '$primary_1' AND a.ptp_date IS NOT NULL AND a.ptp_date >= DATE(NOW())  LIMIT 1";
